...
const getFrameworkUseCase = new GetFrameworkUseCase(
  frameworkRepository,
  controlRepository,
);
const listFrameworksUseCase = new ListFrameworksUseCase(
  frameworkRepository,
  controlRepository,
);
...
const updateControlImplementationUseCase =
  new UpdateControlImplementationUseCase(complianceService);
...
app.use(
  "/api/auth",
  createAuthRouter(authController, authRepository, userRepository),
);
app.use(
  "/api/compliance",
