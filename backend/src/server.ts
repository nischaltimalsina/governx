...
const createEvidenceUseCase = new CreateEvidenceUseCase(evidenceService, controlRepository, frameworkRepository);
const getEvidenceUseCase = new GetEvidenceUseCase(evidenceRepository, controlRepository, frameworkRepository);
const listEvidenceUseCase = new ListEvidenceUseCase(evidenceRepository);
const reviewEvidenceUseCase = new ReviewEvidenceUseCase(evidenceService, controlRepository, frameworkRepository);
const linkEvidenceToControlUseCase = new LinkEvidenceToControlUseCase(evidenceService, controlRepository, frameworkRepository);

// Initialize policy use cases
const createPolicyUseCase = new CreatePolicyUseCase(policyService);
const getPolicyUseCase = new GetPolicyUseCase(policyRepository, controlRepository, frameworkRepository);
