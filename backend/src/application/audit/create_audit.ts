...
import { CreateAuditDTO, AuditDTO } from '../dtos/audit_dtos'
...
export class CreateAuditUseCase {
   ...
   */
  public async execute(request: CreateAuditDTO, userId: string): Promise<Result<AuditDTO, Error>> {
    ...
    // Call domain service to create audit
    const auditResult = await this.auditService.createAudit(
