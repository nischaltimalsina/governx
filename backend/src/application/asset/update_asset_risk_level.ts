...
import { UpdateAssetRiskLevelDTO, AssetDTO } from '../dtos/asset_dtos'

/**
 * Use case for updating an asset's risk level
 */
export class UpdateAssetRiskLevelUseCase {
  ...
  public async execute(
    assetId: string,
    request: UpdateAssetRiskLevelDTO,
    userId: string
    ...
    const updateResult = asset.updateRiskLevel(request.riskLevel, userId)
